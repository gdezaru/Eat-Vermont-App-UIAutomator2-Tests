...
class HomeScreenLocators:
    ...
    EVENTS_WITHIN_30_SEE_ALL = '//*[contains(@text, "{}")]/following-sibling::*//android.widget.TextView[@text="See All"]'
...
class HomeScreenTiles:
    ...
    DAY_TRIPS_TILE = '//android.view.ViewGroup[contains(@content-desc, "{}")]//android.widget.TextView[@text="Read More"]'
